...
public class Protagonista extends Personaje{
    ...
    /**
     * Indica si el protagonista ha completado su turno o está esperando entrada del usuario
     * @return true si el jugador aún no ha realizado su acción, false si ya completó su turno
     */
     ...
     * la entrada del usuario, ya que las acciones se manejan a través de eventos de teclado.
     */
    @Override
    public void jugar(){
